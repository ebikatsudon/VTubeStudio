...
* **Screen Overlay**
  * Sets the Live2D model display overlay settings to the settings recorded in this hotkey. For more info, see [Display Light Overlay](https://github.com/DenchiSoft/VTubeStudio/wiki/Display-Light-Overlay).
